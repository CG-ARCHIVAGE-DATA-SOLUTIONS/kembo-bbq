...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icones/favicon.ico", sizes: "any" },
      { url: "/icones/favicon-16x16.png", sizes: "16x16", type: "image/png" },
      { url: "/icones/favicon-32x32.png", sizes: "32x32", type: "image/png" },
      { url: "/icones/android-chrome-192x192.png", sizes: "192x192", type: "image/png" },
      { url: "/icones/android-chrome-512x512.png", sizes: "512x512", type: "image/png" },
    ],
